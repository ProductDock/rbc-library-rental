...
//import com.productdock.library.rental.ca.domain.BookRentalRecord;
...
//
//import static com.productdock.library.rental.ca.domain.RentalStatus.RENTED;
...
//
//    @Mock
//    private RentalRecordPublisher sendRentalRecordOutPort;
//
//    @Mock
...
//
//        InOrder inOrder = Mockito.inOrder(ANY_BOOK_RENTAL_RECORD, sendRentalRecordOutPort, rentalRecordRepository);
//        inOrder.verify(ANY_BOOK_RENTAL_RECORD).trackActivity(any());
//        inOrder.verify(rentalRecordRepository).save(ANY_RENTAL_ENTITY.get());
//        inOrder.verify(sendRentalRecordOutPort).sendMessage(ANY_BOOK_RENTAL_RECORD);
//    }
//
//    @Test
